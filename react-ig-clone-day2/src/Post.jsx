            ...
            <div className="flex-col justify-center align-center text-center flex-1 font-sans">
                ...
                <div id="popup" className="fixed border-black border-solid border-5 hidden w-[500px] rounded-xl  text-start ml-[425px] mr-[425px] pt-10 pb-3 px-3 bg-gradient-to-b from-yellow-500  via-pink-600  to-indigo-800  ">
                    <div id="popup-head" className="flex align-center justify-between mt-[-25px]">
                        ...
                        <button id="close" 
                        className="bg-black text-white w-8 h-8 rounded-full mb-1 cursor-pointer hover:font-bold">
                            X</button>
                    </div>
                    <input type="text" id="img-url" className="border-black border-solid border-3 pr-68 rounded-sm mb-5 bg-white outline-none" />
                    <p className="font-bold">Username</p>
                    <input type="text" id="username-url"  className="border-black border-solid border-3 pr-68 rounded-sm mb-5 bg-white outline-none"/>
                        ...
                        <div className="mb-5" key={index}> 
                            ...
                            <div className="flex-col align-start">
                                ...
                                <div className="text-start mt-2">
                                    ...
                                    <p className="mb-1">{inf.comments.comment}</p>
                                </div>
